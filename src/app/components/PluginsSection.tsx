...
const plugins = [
  ...
  },
  {
    ...
    tagline: "Chorus",
    description:
      "Lush, dimensional chorus from subtle thickening to wide vintage shimmer. Multi-voice modulation, stereo spread, and a Lush knob for adding chorused reverb to any signal.",
    accentColor: "#0531fa",
    mockType: "chorus",
    comingSoon: true,
    price: 99,
  ...
  },
  {
    ...
    tagline: "Flanger",
    description:
      "From jet-engine sweeps to subtle comb filtering. Tape-style flanger with feedback, manual mode, and a Lush knob for blending reverb into the swept signal.",
    accentColor: "#0531fa",
    mockType: "flanger",
    comingSoon: true,
    price: 99,
  ...
  },
  {
    ...
    tagline: "Phaser",
    description:
      "Classic analog phaser with up to 12 stages of all-pass filtering. Resonance control, stereo spread, and a Lush knob for adding phased reverb to any source.",
    accentColor: "#7900ff",
    mockType: "phaser",
    comingSoon: true,
    price: 99,
  ...
  {
    name: "Lush Doubler",
    tagline: "Vocal Doubler",
    description:
      "Studio-grade vocal doubling with pitch shifting, micro-timing offsets, and stereo spread. Turn a single take into a wide, polished double-tracked performance — with a Lush knob to add space.",
    accentColor: "#00bcff",
    mockType: "doubler",
    comingSoon: true,
    price: 99,
    ...
    <section id="plugins" className="pt-4 pb-16 px-6 scroll-mt-12">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-4">Plugins</h2>
